...
import { UserOrGroupSchema } from "./people";
...
const InnerVerificationSchema = v.variant("state", [
	...
	v.object({
		...
		verified_by: v.nullable(UserOrGroupSchema),
	}),
]);
 ...
 *     verified_by: { id: string; object: "user" | "group"; name: string | null } | null;
 *   }
 * }
 * ```
 *
 ...
 * // parsed.properties.Verification: { state: "unverified" | "verified" | "expired"; date: DateObject | null; verified_by: { id: string; object: "user" | "group"; name: string | null } | null }
 * ```
 */
 ...
 * const page = await notion.pages.retrieve({ page_id: "..." });
 * const parsed = v.parse(PageSchema, page);
 * // parsed.properties.Verification: { state: "unverified" | "verified" | "expired"; date: DateObject | null; verified_by: { id: string; object: "user" | "group"; name: string | null } | null } | null
 * ```
 */
